...
- **`saveImg`** *(boolean, optional, default: false)*:
  Save the screenshot to disk in the chosen format.

- **`savePath`** *(string, optional)*:
  Save screenshot to this path. Can be a directory (auto-generates filename) or a full file path.
---
